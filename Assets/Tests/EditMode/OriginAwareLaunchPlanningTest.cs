...
public class OriginAwareLaunchPlanningTest : TestBase {
    ...
    public void SetUp() {
        ...
        _staticOrigin = new InterceptorOriginConfig {
            id = "Static-Test-Origin",
            initial_position = new Vector3(1000, 0, 2000),
        ...
        _movingOrigin = new InterceptorOriginConfig {
            id = "Moving-Test-Origin",
            initial_position = new Vector3(500, 0, 1000),
    ...
    public void TestIterativeLaunchPlanner_WithOrigin_StaticOrigin() {
        ...
        _mockLaunchAnglePlanner.SetMockResponse(45f, 10f); // 45 degree launch angle, 10 second time-to-intercept
    ...
    public void TestLaunchAnglePlanner_OriginRelativeVsZeroOrigin() {
        ...
        Assert.AreNotEqual(outputFromNonZeroOrigin.DistanceToTarget, outputFromZeroOrigin.DistanceToTarget,
