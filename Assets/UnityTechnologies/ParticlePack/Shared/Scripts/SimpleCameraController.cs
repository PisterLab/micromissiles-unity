...
namespace UnityTemplateProjects {
  public class SimpleCameraController : MonoBehaviour {
    ...
    void Update() {
      ...
      // Modify movement by a boost factor (defined in Inspector and modified in play mode through
      ...
      // Calculate the lerp amount, such that we get 99% of the way to our target in the specified
      // time
      var positionLerpPct =
